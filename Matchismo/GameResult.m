...
- (id)initFromPropertyList:(id)plist
{
    ...
    if (self) {
        if ([plist isKindOfClass:[NSDictionary class]]) {
            ...
            _difficulty = resultDictionary[DIFFICULTY_KEY];
...
- (id)asPropertyList
{
    return @{ START_KEY : self.start, END_KEY : self.end, SCORE_KEY : @(self.score), GAME_KEY : self.game, DIFFICULTY_KEY : self.difficulty };
}
